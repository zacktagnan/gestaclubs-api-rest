...
#[Group('api:v1:feat:management:coaches:remove_from_club')]
class RemoveFromClubTest extends CoachTestCase
{
    ...
    #[Test]
    #[Group('api:v1:feat:management:coaches:remove_from_club:success')]
    ...
    #[Test]
    #[Group('api:v1:feat:management:coaches:remove_from_club:not_be_found')]
    ...
    #[Test]
    #[Group('api:v1:feat:management:coaches:remove_from_club:too_many_requests')]
    ...
    #[Test]
    #[Group('api:v1:feat:management:coaches:remove_from_club:unauthenticated')]
    ...
    #[Test]
    #[Group('api:v1:feat:management:coaches:remove_from_club:notification_failure')]
